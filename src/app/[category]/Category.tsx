        ...
        <div className='container mx-auto px-2 flex gap-6 xl:gap-10 mt-10'>
            ...
            <div className='w-full lg:w-[75%]'>
                <div className='space-y-3'>
                    ...
                    <div>
                        <p className="leading-7 text-gray-800">{displayText} {isTruncated && ( <button onClick={handleReadMore} className="text-primary font-medium mt-1 hover:underline" >Read More...</button>)}</p>
                    </div>
                </div>
                <div className='pt-6'>
                ...
                <div className="flex flex-wrap lg:flex-nowrap md:items-center justify-between bg-white w-full py-2 gap-4 md:gap-2 xl:gap-4 mt-6 pt-6 border-t border-[#0000003D] border-b md:border-b-0">
                    ...
                    <div className="flex lg:hidden">
                        ...
                        <div className={`fixed top-0 left-0 ${showFilters ? 'left-0 w-full' : 'left-[150%] w-0'} bg-white px-4 xs:px-6 pt-10 z-50`}>
                            <div className='overflow-y-auto overflow-x-visible h-screen'>
                                <Filters />
                            </div>
                            <button className='text-black absolute top-3 right-3' onClick={() => setShowFilters(!showFilters)}><RxCross2 size={20} /></button>
                        </div>
                    </div>
                ...
                <div className='grid grid-cols-2 xl:grid-cols-3 gap-2 pt-6'>
                    {Array(3).fill(products).flat().map((item, index) => (
                ...
                <div className='flex justify-center items-center gap-2 pt-6'>
                    ...
                    <button className='w-7 h-7 flex justify-center items-center border border-black font-medium text-xl'>1</button>
                    <button className='w-9 h-9 flex justify-center items-center font-medium text-xl bg-primary text-white shadow-xl'>2</button>
                    <button className='w-7 h-7 flex justify-center items-center border border-black font-medium text-xl'>3</button>
