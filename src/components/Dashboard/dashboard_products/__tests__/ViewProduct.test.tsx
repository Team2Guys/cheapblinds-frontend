...
const mockProducts: IProduct[] = [
   {
      ...
      last_editedBy: 'admin',
      posterImageUrl: { imageUrl: '/macbook.jpg', public_id: 'img1', resource_type: 'image' },
      price: 2000,
      discountPrice: 1800,
      stock: 5,
      category: { id: 10, name: 'Laptops', custom_url: 'laptops', posterImageUrl: { imageUrl: '/macbook.jpg', public_id: 'img1', resource_type: 'image' } },
      subcategory: { id: 11, name: 'Mac', custom_url: 'mac', posterImageUrl: { imageUrl: '/macbook.jpg', public_id: 'img1', resource_type: 'image' } },
      custom_url: 'macbook-pro',
      status: 'PUBLISHED',
      hoverImageUrl: { imageUrl: '/macbook.jpg', public_id: 'img1', resource_type: 'image' },
      productImages: [],
   },
];
