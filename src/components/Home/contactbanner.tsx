...
const ContactBanner = () => {
  return (
        ...
        <p className="text-primary text-[51px] lg:text-[57px] font-rubik font-semibold leading-[0.7]">
            Ready <span className="font-medium text-[27px] text-black">to Decide? <br />
            Let's Set It Up </span><br />
           <span className='ml-8 block mt-5'> Instantly!</span>
             </p>

       <Link href="tel:+971 50 597 4531" className="flex items-start gap-3 mt-10">
        <p><Phone className='h-8 w-8 mt-2' />
        </p>
       ...
       <ContactForm variant="noLabel" />
        ...
        <Image className='bg-cover w-[300px]'  alt='callperson' height={200} width={200} src="/assets/images/phnmbl.webp"/>
        </div>
        </div>
   </div>
  )
