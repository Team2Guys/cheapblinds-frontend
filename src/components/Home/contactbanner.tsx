...
const ContactBanner: React.FC<ContactBannerProps> = ({ bgcolor = false }) => {
  return (
    <div className="container mx-auto">
      <div
        className={`flex flex-col sm:flex-row text-black ${
          bgcolor ? "bg-primary-light" : ""
        } bg-no-repeat sm:gap-4 sm:bg-center bg-fill sm:bg-[url('/assets/images/phnperson.webp')] w-full px-5 pt-10 sm:pb-3`}
      >
        {/* Left Section */}
