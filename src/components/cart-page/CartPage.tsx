            ...
            <div key={item.id} className="flex p-2 text-xl border-b-2 border-secondary">
              <div className="w-full lg:w-[64%]">
                <div className="flex lg:hidden justify-end">
                  <div
                    className="rounded-full bg-primary-light w-fit h-fit p-2 text-center cursor-pointer"
                ...
                <div className="flex lg:flex-nowrap gap-4 pr-2 py-6">
                  ...
                  <div className="flex lg:hidden justify-between items-center h-14 w-9/12">
                    <Counter
                      increase={() => increaseQuantity(String(item.id))}
                      decrease={() => decreaseQuantity(String(item.id))}
                  ...
                  <SelectOption
                    ...
                    cartData={item}
                    updateMotorized={updateMotorized}
                  />
                </div>
