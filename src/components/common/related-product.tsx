    ...
    <div className="container mx-auto px-2 space-y-3 mt-10 md:mt-16 ">
      ...
      <SlickSlider slidesToShow={4}>
        {data.map((array, index) => (
          <div key={index} className="md:px-2 h-fit" onMouseDown={handleMouseDown} onMouseMove={handleMouseMove}>
              ...
              {array.title &&
                <div className="py-3 space-y-1">
                  ...
                  <p className="text-2xl font-rubik font-semibold flex items-center gap-2">
                    <span className="font-currency text-2xl mb-1"></span>{array.price}
                  </p>
                </div>
              }
              </div>
