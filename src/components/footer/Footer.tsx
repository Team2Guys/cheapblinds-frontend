                ...
                <div className="flex flex-col sm:flex-row gap-6 2xl:gap-10 items-start">
                    <div className="w-full sm:w-1/3 flex flex-col items-start justify-between relative h-[360px]">
                        ...
                        <div className="mt-4 space-y-3 text-sm z-0">
                            ...
                            <Link href='tel:+971505974531' className="flex items-center space-x-2 font-medium font-rubik text-xl">
                                <Image
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 sm:col-span-3 gap-6 lg:gap-0'>
                            <div className="lg:mt-10 flex flex-col gap-2">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <div className='flex justify-center items-center rounded-md bg-white w-12 xs:w-14 h-8'>
                                        <Image src="/assets/icons/applepay.png" alt="Apple Pay" width={26} height={12} />
                                    </div>
                                    <div className='flex justify-center items-center rounded-md bg-white w-12 xs:w-14 h-8'>
                                        <Image src="/assets/icons/tabby.png" alt="Tabby" width={37} height={15} />
                                    </div>
                                    <div className='flex justify-center items-center rounded-md bg-white w-12 xs:w-14 h-8'>
                                        <Image src="/assets/icons/mastercard.png" alt="Mastercard" width={26} height={16} />
                                    </div>
                                    <div className='flex justify-center items-center rounded-md bg-white w-12 xs:w-14 h-8'>
