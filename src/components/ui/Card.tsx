    ...
    >
      <div className="relative h-40 md:h-80 xl:h-72">
        <Image
          ...
          alt={card.posterImageUrl.altText || card.name}
          fill
        />
        <div className="absolute bottom-2 left-2">
          <div className="relative h-9 md:h-16 w-7 md:w-14">
            <Image
              src={card.deliveryImageUrl.imageUrl}
              alt={card.deliveryImageUrl.altText || "image"}
              fill
      ...
      <div className="pt-3 space-y-4">
        ...
        <div className="flex justify-between items-center gap-1 md:gap-2">
          <button className="bg-primary w-28 md:w-44 h-6 md:h-10 text-[10px] md:text-base flex justify-center items-center rounded-md font-semibold">
            Free Sample
          </button>
          <span
